...
typedef DBoW2::TemplatedDatabase<DBoW2::FORB::TDescriptor, DBoW2::FORB>
    OrbDatabase;
/// BRIEF Vocabulary
typedef std::shared_ptr<OrbVocabulary> OrbVocabularyPtr;
/// BRIEF Database
typedef std::shared_ptr<OrbDatabase> OrbDatabasePtr;
...
/// BRIEF Vocabulary
typedef std::shared_ptr<BriefVocabulary> BriefVocabularyPtr;
/// BRIEF Database
typedef std::shared_ptr<BriefDatabase> BriefDatabasePtr;
