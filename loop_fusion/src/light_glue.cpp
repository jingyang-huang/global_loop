...
bool SuperPointLightGlue::construct_network(SampleUniquePtr<nvinfer1::IBuilder> &builder, SampleUniquePtr<nvinfer1::INetworkDefinition> &network,
                                            SampleUniquePtr<nvinfer1::IBuilderConfig> &config, SampleUniquePtr<nvonnxparser::IParser> &parser) const {
...
void SuperPointLightGlue::save_engine() {
  ...
  if (engine_ != nullptr) {
    ...
    std::cout<<"lg save engine success!" << std::endl;
  }
}
