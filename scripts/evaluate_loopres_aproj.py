...
v0_nx_rs_ref13_reloT = datapath + '/v0_nx_rs_ref13_reloT_track.txt'
dld_rs_ref13_mappT = datapath + '/dld_omni_ref13_mappT.txt'
...
# 读取数据
loopPdFrame = pd.read_csv(v0_nx_rs_ref13_reloT, sep=" ", header=None)
# loopPath = pd.read_csv(v1_nx_rs_ryjy3_loop, sep=" ", header=None)
# vioPath = pd.read_csv(v1_nx_rs_ryjy3_vio, sep=" ", header=None)

loopPdFrame_mapp = pd.read_csv(dld_rs_ref13_mappT, sep=" ", header=None)
