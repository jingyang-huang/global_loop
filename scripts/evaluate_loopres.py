...
v0_dld_rs_ref0_loop = datapath + '/v0_dld_rs_ref0_loop.txt'
...
v1_nx_rs_ryjy3_vio = datapath + '/v1_nx_rs_ryjy3_vio.txt'
...
v0_r0_reloT_pgo = datapath + '/v0_r0_reloT_pgo.txt'
v0_dld_omni_r0_reloT=datapath + '/v0_dld_omni_r0_reloT.txt'
v0_dld_rs_r0_reloT = datapath + '/v0_dld_rs_r0_reloT.txt'
v0_dld_rs_refyjy1_reloT = datapath + '/v0_dld_rs_refyjy1_reloT.txt'
v0_dld_rs_refyjy2_reloT = datapath + '/v0_dld_rs_refyjy2_reloT.txt'
v0_dld_rs_ryjy3_reloT = datapath + '/v0_dld_rs_ryjy3_reloT.txt'
v0_dld_rs_ryjy3_reloT_nopgo  = datapath + '/v0_dld_rs_ryjy3_reloT_nopgo.txt'
v1_nx_rs_ryjy3_reloT = datapath + '/v1_nx_rs_ryjy3_reloT.txt'
v2_nx_rs_ref3_reloT = datapath + '/v2_nx_rs_ref3_reloT.txt'
v1_dld_rs_ref4_reloT = datapath + '/v1_dld_rs_ref4_reloT.txt'
v0_dld_rs_ref5_reloT = datapath + '/v0_dld_rs_ref5_reloT.txt'
v1_dld_rs_ref5_reloT = datapath + '/v1_dld_rs_ref5_reloT.txt'
v2_dld_rs_ref5_reloT = datapath + '/v2_dld_rs_ref5_reloT.txt'
v3_dld_rs_ref5_reloT = datapath + '/v3_dld_rs_ref5_reloT.txt'
v3_dld_rs_ref6_reloT = datapath + '/v3_dld_rs_ref6_reloT.txt'
v3_dld_rs_ref6_reloT_far = datapath + '/v3_dld_rs_ref6_reloT_far.txt'
v0_dld_rs_ref7_reloT = datapath + '/v0_dld_rs_ref7_reloT.txt'
v0_nx_rs_ref7_reloT = datapath + '/v0_nx_rs_ref7_reloT.txt'
v2_nx_rs_ref7_reloT = datapath + '/v2_nx_rs_ref7_reloT.txt'
v3_nx_rs_ref9_reloT = datapath + '/v3_nx_rs_ref9_reloT.txt'
v7_nx_rs_ref9_reloT = datapath + '/v7_nx_rs_ref9_reloT.txt'
v8_nx_rs_ref9_reloT = datapath + '/v8_nx_rs_ref9_reloT.txt'
v0_nx_rs_ref10_reloT = datapath + '/v0_nx_rs_ref10_reloT.txt'
v1_nx_rs_ref10_reloT = datapath + '/v1_nx_rs_ref10_reloT.txt'
v1_nx_rs_ref11_reloT = datapath + '/v1_nx_rs_ref11_reloT.txt'
v1_nx_rs_ref11_reloT = datapath + '/v1_nx_rs_ref11_reloT.txt'
...
dld_usb_ref6_mappT =datapath + '/dld_usb_ref6_mappT.txt'
dld_rs_ref7_mappT =datapath + '/dld_rs_ref7_mappT.txt'
dld_rs_ref8_mappT =datapath + '/dld_rs_ref8_mappT.txt'
dld_rs_ref9_mappT = datapath + '/dld_rs_ref9_mappT.txt'
dld_rs_ref10_mappT = datapath + '/dld_rs_ref10_mappT.txt'
...
# 读取数据
loopPdFrame = pd.read_csv(v2_dld_rs_ref11_reloT, sep=" ", header=None)
...
t_diff_norm = np.sqrt(x_diff**2 + y_diff**2 + z_diff**2)/3
...
plt.figure(figsize=(10, 10))
# 轨迹
plt.plot(loopPdFrame[2], loopPdFrame[3],'-.', color ='royalblue',label='lio')
# 发生回环的位置
plt.plot(loopPdFrame_1[2], loopPdFrame_1[3], 'g*', label='right loop')  # 星型标记
plt.plot(loopPdFrame_2[2], loopPdFrame_2[3], 'rx', label='false loop')  # x型标记
